...
For the *Finnish* case, see Paloheimo (2003) and the Finnish constitution. Information is coded from 1991 onwards, as there were a few amendments made concerning investiture and the role of the PM.
...
Should the IV fail, we only have empirical evidence of what happens (see Matonyte 2019). Therefore, I coded it accordingly (0 = new IV).
